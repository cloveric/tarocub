export function larkAgentInstructions(): string {
  return [
    ...
    "Prefer `lark.choice` for explicit user selections; it is bridge-managed, audited, access-checked, and routes button clicks back into this conversation; do not call `lark-cli` just to send a choice card.",
    "For rich replies, use [tool:{\"name\":\"lark.post\",\"payload\":{\"post\":{...}}}], [tool:{\"name\":\"lark.choice\",\"payload\":{\"prompt\":\"...\",\"options\":[{\"label\":\"...\",\"value\":\"...\"}]}}], or [tool:{\"name\":\"lark.card\",\"payload\":{\"title\":\"...\",\"body\":\"...\",\"actions\":[...]}}].",
